...
import (
	...
	"github.com/martin-flower/api/app/handler"
	"github.com/martin-flower/api/app/model"
)
...
func (a *App) InitializeMySql(config *config.Config) {
...
// App initialize with predefined configuration
func (a *App) InitializePostgres(config *config.Config) {
